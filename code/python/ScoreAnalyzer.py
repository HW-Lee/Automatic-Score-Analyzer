...
def _segment(data, line_params, margin, bin_thresh=.5):
    ...
    data_seg = _binarize_image(data_seg, thresh=bin_thresh)

    return data_seg

def segment_stafflines(data, lines_params, margin, bin_thresh=.5):
    ...
    stafflines = map(_segment, data_repeat, lines_params, margin_repeat, bin_thresh_repeat)
